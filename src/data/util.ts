...
export const getProjects = async () => {
  ...
  try {
    ...
    p = Object.values(projectModules) as Project[];
    p.sort((a, b) => b.default.id - a.default.id);
    return p;
  } catch (e) {
    console.log(e);
  }
...
export type TechnologyCategory = "languages" | "frameworks" | "sap" | "nonsap" | "inf" | "other";

export const categoryTitles: Record<TechnologyCategory, string> = {
...
export const getCategoryTitle = (category: TechnologyCategory): string => {
...
export const getTechnologies = (): Record<TechnologyCategory, Technology[]> => {
