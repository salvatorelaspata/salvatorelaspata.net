...
**Projects** ([src/data/projects/](src/data/projects/)): JSON files numbered by ID (01*\*.json, 02*\*.json, etc.)

- Schema: `id`, `title`, `subtitle`, `img`, `description`, `technologies`, optional `github`, `demo`, `npm`, `slides`
...
2. Use schema: `id`, `title`, `subtitle`, `img`, `description`, `technologies`, optional `github`/`demo`/`npm`/`slides`
